...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('2000-02-03','2000-05-16','2000-08-24','2000-11-10')))
 ...
 and sr_reason_sk in (8, 13, 56, 63, 64)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (8, 13, 56, 63, 64)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (8, 13, 56, 63, 64)
 group by i_item_id)
