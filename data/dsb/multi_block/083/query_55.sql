...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('2000-03-09','2000-05-29','2000-08-09','2000-10-02')))
 ...
 and sr_reason_sk in (1, 14, 34, 38, 69)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (1, 14, 34, 38, 69)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (1, 14, 34, 38, 69)
 group by i_item_id)
