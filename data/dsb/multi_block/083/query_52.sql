...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('2001-03-04','2001-04-27','2001-08-27','2001-11-16')))
 ...
 and sr_reason_sk in (6, 7, 34, 44, 46)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (6, 7, 34, 44, 46)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (6, 7, 34, 44, 46)
 group by i_item_id)
