...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('1999-01-25','1999-06-17','1999-08-17','1999-10-29')))
 ...
 and sr_reason_sk in (19, 30, 32, 46, 48)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (19, 30, 32, 46, 48)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (19, 30, 32, 46, 48)
 group by i_item_id)
