...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('2002-01-05','2002-04-05','2002-09-14','2002-10-20')))
 ...
 and sr_reason_sk in (14, 31, 36, 58, 62)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (14, 31, 36, 58, 62)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (14, 31, 36, 58, 62)
 group by i_item_id)
