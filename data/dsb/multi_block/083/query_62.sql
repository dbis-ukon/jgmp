...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('2001-01-28','2001-05-16','2001-07-22','2001-11-18')))
 ...
 and sr_reason_sk in (12, 28, 40, 67, 71)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (12, 28, 40, 67, 71)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (12, 28, 40, 67, 71)
 group by i_item_id)
