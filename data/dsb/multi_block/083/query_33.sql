...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('2002-03-23','2002-04-25','2002-07-28','2002-11-02')))
 ...
 and sr_reason_sk in (4, 21, 22, 43, 68)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (4, 21, 22, 43, 68)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (4, 21, 22, 43, 68)
 group by i_item_id)
