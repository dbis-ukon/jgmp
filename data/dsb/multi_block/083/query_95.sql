...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('2000-03-10','2000-04-10','2000-07-29','2000-10-06')))
 ...
 and sr_reason_sk in (5, 11, 30, 31, 40)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (5, 11, 30, 31, 40)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (5, 11, 30, 31, 40)
 group by i_item_id)
