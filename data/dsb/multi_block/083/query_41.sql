...
with sr_items as
 ...
 and   d_date    in
	...
	where d_month_seq in
		(select d_month_seq
		from date_dim
	  where d_date in ('1999-02-24','1999-05-05','1999-07-30','1999-10-12')))
 ...
 and sr_reason_sk in (10, 14, 24, 51, 59)
group by i_item_id),
 cr_items as
 (select i_item_id item_id,
 ...
 and cr_reason_sk in (10, 14, 24, 51, 59)
 group by i_item_id),
 wr_items as
 (select i_item_id item_id,
 ...
 and wr_reason_sk in (10, 14, 24, 51, 59)
 group by i_item_id)
