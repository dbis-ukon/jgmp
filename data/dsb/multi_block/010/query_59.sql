...
select 
 ...
 where
  ...
  ca_county in ('Bedford city','Lincoln County','Monroe County','Northumberland County','Osage County') and
  c.c_birth_month in (10, 12) and
  cd_demo_sk = c.c_current_cdemo_sk
  and cd_marital_status in ('S', 'S', 'S')
  and cd_education_status in ('Secondary', 'Unknown', 'Advanced Degree')
  and cd_gender = 'M' and
  exists (select *
