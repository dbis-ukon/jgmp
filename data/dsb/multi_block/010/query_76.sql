...
select 
 ...
 where
  ...
  ca_county in ('Benton County','Butler County','Carroll County','Falls Church city','Hardin County') and
  c.c_birth_month in (8, 10) and
  cd_demo_sk = c.c_current_cdemo_sk
  and cd_marital_status in ('M', 'S', 'U')
  and cd_education_status in ('Unknown', 'Primary', 'Primary')
  and cd_gender = 'M' and
  exists (select *
