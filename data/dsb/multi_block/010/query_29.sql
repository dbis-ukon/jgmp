...
select 
 ...
 where
  ...
  ca_county in ('Avoyelles Parish','Cassia County','Clarke County','Keya Paha County','Silver Bow County') and
  c.c_birth_month in (5, 10) and
  cd_demo_sk = c.c_current_cdemo_sk
  and cd_marital_status in ('U', 'D', 'S')
  and cd_education_status in ('Unknown', 'Primary', '2 yr Degree')
  and cd_gender = 'F' and
  exists (select *
