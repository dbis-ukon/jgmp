...
from torch.nn import ModuleList, Sequential, LeakyReLU
...
# This is just normal PNA conv with LeakyRelu activation functions.
# Newer torch_geometric versions support this naturally, but I would have to update cuda on multiple machines.



class CustomPNAConv(MessagePassing):
